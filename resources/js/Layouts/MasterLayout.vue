...
<template>
    <div class="flex max-h-full h-full overflow-hidden  bg-gray-50 dark:bg-gray-900" >
        <!-- Desktop sidebar -->
        <MasterAsidebar :subjects="subjects" :sections="sections" :sec_met="sec_met" :meetings="meetings" :project="project"/>
        ...
        <div class="flex flex-col flex-1 w-full h-full">
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                ...
                <div class="flex justify-center flex-1 lg:mr-32">
                    ...
                    <input
                        class="w-full pl-8 pr-3 p-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                        type="text"
                        placeholder="Buscar"
                        aria-label="Search"
                    />
