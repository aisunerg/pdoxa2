    ...
    <div class="overflow-auto w-full" style="height: 83%;" id="semestres">
        <div v-for="semestre in semestres" :key="semestre" >
            <div class="flex justify-end mr-5 h-6 ">
              <div class="relative">
                  <div @click="imprimir('semestre-'+semestre) " class="absolute top-1 -right-3 flex flex-inline gap-1 bg-purple-300 hover:bg-purple-400 px-2 py-1 text-purple-500 hover:text-white  rounded-md cursor-pointer">
                    <div class="">
