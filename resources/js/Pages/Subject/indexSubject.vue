                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3">Unidad de Credito</th>
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <tr v-for="subject in subjects" :key="subject.id" class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">
                                        <p class="font-semibold">{{ subject.avr }}</p>
                                    </td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3">
                                        <p class="font-semibold">{{selectObj(subject.departament_id, departaments)}}</p>
                                    </td>                                   
                                    <td class="px-4 py-3">
                                        <p class="font-semibold">{{ subject.created_at }}</p>
                                    </td>
